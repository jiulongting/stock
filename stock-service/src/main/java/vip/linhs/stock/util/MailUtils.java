...
public final class MailUtils {
    private static final String USER = "945659921@qq.com"; // 发件人称号，同邮箱地址
    private static final String PASSWORD = "rjyctoqrzzubbcga"; // 户端授权码
    ...
    public static void main(String[] args) throws Exception { // 做测试用
        MailUtils.sendMail("945659921@qq.com","你好，这是一封测试邮件，无需回复。","测试邮件");
