...
public class StockSelectedDaoImpl extends BaseDao implements StockSelectedDao {
    ...
    private static final String SQL_SELECT_BASE_COLUMNS = "select name as name, id as id, code as code, rate as rate, create_time as createTime, update_time as updateTime, description as description from stock_selected where 1 = 1";
